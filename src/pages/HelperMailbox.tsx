  ...
  const messages: Message[] = [
    {
      ...
      message: "Paldies, ka pievienojies mūsu palīgu komandai. Ja tev ir kādi jautājumi, droši sazinies ar mums!",
      date: "2025-01-10",
      read: true
    }
  ];
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        ...
                        {message.fromType === "admin" ? "Administrācija" : "Klients"}
                      </span>
                      {!message.read && (
